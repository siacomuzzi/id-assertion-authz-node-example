...
You must specify the issuer and client credentials in your `.env.wiki` file to hook up the authorization server to your IDP:
...
Finally, configure Auth0 as the authorization server for ToDo0:

**packages/todo0/.env**

```
AUTH_SERVER="https://todo0.auth0lab.com"
CLIENT1_CLIENT_ID="<todo0-client-id>"
CLIENT1_CLIENT_SECRET="<todo0-client-secret>"
```

**packages/wiki0/.env**

```
TODO_AUTH_SERVER="https://todo0.auth0lab.com"
CLIENT2_CLIENT_ID="<wiki0-at-todo0-client-id>"
CLIENT2_CLIENT_SECRET="<wiki0-at-todo0-client-secret>"
```
